...
Public Class frm_DescargarArchivo
    ...
    Private Sub frm_DescargarArchivo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If Not Cn_Facturacion.fn_ModulosArchivos_LlenarLista(lsv_Archivos, ModuloClave) Then
    ...
    Sub DescargarArchivo()
        ...
        Try
            ...
            Dim fileData As Byte() = Cn_Facturacion.fn_Archivos_Descargar(lsv_Archivos.SelectedItems(0).Tag)
