...
#Region "Funciones Privadas"
    ...
    Sub ExportarCompleto()
        ...
        Dim RemisionAnterior As Integer = 0
        ...
        For Each Padre As DataRow In Padres.Rows
            ...
            For Each Hijo As DataRow In Hijos.Rows 'For para hijos...
                ...
                '14/04/2014 lunes ------
                If sheet.name = "Sheet1" Then Suma = "=Sum" Else Suma = "=Suma"
                ...
                subTotalaCobrar = Val(ArrayFact(cuenta).CobroXTraslado) + Val(ArrayFact(cuenta).CobroXMiles) + _
                                  Val(ArrayFact(cuenta).CobroXKilometros) + Val(ArrayFact(cuenta).CobroXCajaFuerte) + _
                                  Val(ArrayFact(cuenta).CobroXProceso) + Val(ArrayFact(cuenta).CobroXPernoctas) + _
