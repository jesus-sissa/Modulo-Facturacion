...
#Region "Eliminar Ficha"
    ...
    '                                                         ByVal Tipo_Salida As Integer, ByVal Imp_Documentos As Decimal, ByVal Imp_Nom As Decimal) As Boolean

    '        Dim Tr As SqlTransaction = crear_Trans(Crea_ConexionSTD)

    '        Dim Id_Dotacion As Integer = fn_PrepararDotaciones_Crear_Dotacion(Tr, Id_CajaBancaria, Id_ClienteP, Id_Moneda, Importe, Fecha_Entrega, Documentos, Nomina, Cantidad_Sobres, HoraSolicita, Tipo_Salida, Imp_Documentos, Imp_Nom)
    ...
    '                                                             ByVal HoraSolicita As String, ByVal Tipo_Salida As Integer, ByVal Imp_Doc As Decimal, ByVal Imp_Nominas As Decimal) As Integer
    '    Dim Tipo As Integer = 1
    '    If Nomina = "S" Then Tipo = 3
