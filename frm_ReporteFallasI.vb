...
Public Class frm_ReporteFallasI
    ...
    Sub Correo()
        ...
        Dim ArchivoAdjunto As String = Tbx_Adjunto.Text
        If ArchivoAdjunto <> "" Then ArchivoAdjunto = System.IO.Path.GetFileName(Tbx_Adjunto.Text)
        ...
        Dim DetalleHTML As String = "<html><body><table style='border: solid 1px' width='100%'><tr><td colspan='4' align='center'><b>Boletín Informativo</b></td></tr>" _
                                        ...
                                        & "<tr><td align='right'><label><b>Archivo Adjunto:</b></label></td><td>" & ArchivoAdjunto & "</td><td></td><td></td></tr>" _
                                        & "<tr><td colspan='4'><hr /></td></tr><tr><td colspan='3' align='center'>Pie</td></tr></table><br/><br/></body></html>"

        'Generar Alerta y enviar Correo
        If Not Cn_Facturacion.fn_AlertasGeneradas_Guardar("29", Detalle, Nothing, True, TipoSolicitud.ToUpper, Tbx_Adjunto.Text, DetalleHTML) Then
