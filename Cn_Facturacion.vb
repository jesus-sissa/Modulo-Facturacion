...
#Region "Reporte de Dotaciones"
    ...
    Public Shared Function fn_ReporteDotaciones_GenerarExcel(ByVal Id_CajaBancaria As Integer, ByVal Id_Moneda As Integer, ByVal Desde As Date, ByVal Hasta As Date, ByVal Id_GrupoF As Integer, ByVal Tipo As Integer, ByVal Encabezado1 As String, ByVal Encabezado2 As String) As Boolean
        ...
        With App
            ...
            If .Worksheets(1).name = "Sheet1" Then Suma = "=Sum" Else Suma = "=Sum"
...
#Region "Consulta de Factura"
    Public Shared Function fn_ConsultaFacturas(ByVal lsv As cp_Listview, ByVal Desde As Date, ByVal Hasta As Date, FacturaOServicio As Integer, CodigoCliente As String, ccval As Integer, TVal As String) As DataTable
        Dim Dt As New DataTable
        Dim _CodigoCliente
        _CodigoCliente = CodigoCliente
        Dim tipo As Integer = 0
        If TVal = "ICCP" Or TVal = "TCCP" Then
            tipo = 1
        End If

        Dim cmd As SqlCommand = Crea_Comando("Reporte_Get_ConsultaFacturas", CommandType.StoredProcedure, Crea_ConexionSTD)
        Dim _desde As String = Desde.Day.ToString() + "/" + Desde.Month.ToString() + "/" + Desde.Year.ToString()
        Dim _hasta As String = Hasta.Day.ToString() + "/" + Hasta.Month.ToString() + "/" + Hasta.Year.ToString()
        Crea_Parametro(cmd, "@FDesde", SqlDbType.DateTime, Convert.ToDateTime(_desde))
        Crea_Parametro(cmd, "@FHasta", SqlDbType.DateTime, Convert.ToDateTime(_hasta))
        Crea_Parametro(cmd, "@FacturaOServicio", SqlDbType.Int, FacturaOServicio)
        Crea_Parametro(cmd, "@CodigoCliente", SqlDbType.VarChar, _CodigoCliente)
        Crea_Parametro(cmd, "@CCVal", SqlDbType.Int, ccval)
        Crea_Parametro(cmd, "@Tipo", SqlDbType.Int, tipo)
        Crea_Parametro(cmd, "@TVal", SqlDbType.VarChar, TVal)
        Dt = EjecutaConsulta(cmd)
        Dim ResP = False
        ...
        '    lsv.Actualizar(cmd, "IDDOCUMENTO")
        '    'Dt = EjecutaConsulta(cmd)
        '    'Dim lvItem As ListViewItem
        '    'For y = 0 To Dt.Rows.Count - 1
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(0))
        '    '    'FILA DESCRIPCIÓN
        '    '    lvItem.SubItems.Add(Dt.Rows(y)(1))
        '    '    lvItem.SubItems.Add(Dt.Rows(y)(2))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(3))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(4))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(5))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(6))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(7))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(8))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(9))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(10))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(11))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(12))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(13))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(14))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(15))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(16))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(17))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(18))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(19))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(20))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(21))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(22))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(23))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(24))
        '    '    lvItem = lsv.Items.Add(Dt.Rows(y)(25))
        '    '    lsv.Update()
        '    'Next
        '    ResP = True
        'Catch ex As Exception
    ...
    Public Shared Function ComboCliente() As List(Of String)
        Dim _lista As New List(Of String)
        Dim cmd As SqlCommand = Crea_Comando("Reporte_Get_ComboClientes", CommandType.StoredProcedure, Crea_ConexionSTD)
        Dim dt As New DataTable

        Try
            dt = EjecutaConsulta(cmd)
            For Each row As DataRow In dt.Rows
                _lista.Add(row("crazonsocial"))
            Next
        Catch ex As Exception
...
#End Region
    ...
    Public Shared Function fn_DetalleDepositos_LlenarRemisiones(ByVal lsv As cp_Listview, ByVal Id_CajaBancaria As Integer,
                                                                ByVal Id_Cliente As Integer,
                                                                ByVal S_Desde As Integer, ByVal S_Hasta As Integer,
                                                                ByVal Id_Moneda As Integer, ByVal Id_GrupoF As Integer,
...
#Region "Consulta de Solicutud de Materieles-Traslados"
    Public Shared Function fn_RemisonDigitalWeb(ByVal lsv As cp_Listview, ByVal Numero_Remision As Double)

        Try
            'Aqui se llena el listview
            Dim Cnn As SqlClient.SqlConnection = Cn_Datos.Crea_ConexionSTD
            Dim Cmd As SqlClient.SqlCommand = Cn_Datos.Crea_Comando("Mat_Get_RemsiionDigital", CommandType.StoredProcedure, Cnn)
            Cn_Datos.Crea_Parametro(Cmd, "@Numero_Remision", SqlDbType.VarChar, Numero_Remision)
    ...
    Public Shared Function fn_ObtenerMateriales(ByVal Numero_Remision As String) As DataTable
