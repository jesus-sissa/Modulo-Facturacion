...
Public Class frm_ConsultaDepositos
    ...
    Private Sub LlenarLista()
        Call Limpiar()
        SegundosDesconexion = 0
        RegistrosNum(Lbl_Registros, lsv_Dotaciones.Items.Count)
        ...
        If Validar() Then
            ...
            TipoConsulta = "S"
            If Not Cn_Facturacion.fn_ConsultaDepositos_LlenarRemisiones(lsv_Dotaciones, cmb_CajaBancaria.SelectedValue, TipoConsulta, dtp_Desde.Value, dtp_Hasta.Value,
    ...
    Private Sub Btn_Desbloquear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Desbloquear.Click
        ...
        Btn_Desbloquear.Visible = False
        Me.Refresh()
        If Cn_Facturacion.Fn_ConsultaDepositos_Desbloqueo(lsv_Dotaciones.SelectedItems(0).SubItems(12).Text, "IN") = False Then
