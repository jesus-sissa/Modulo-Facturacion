Imports Modulo_Facturacion.Cn_DepositosXcuenta

Public Class frm_DepositosPorCuenta

    Private Sub frm_DepositosPorCuenta_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmDepositosPorCuenta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cmb_Grupo.AgregaParametro("@Id_CajaBancaria", -1, 1)
        cmb_Grupo.Actualizar()

        cmb_Cuenta.AgregaParametro("@Id_CajaBancaria", -1, 1)
        cmb_Cuenta.AgregaParametro("@Id_Moneda", -1, 1)
    ...
    Private Sub cmb_CajaBancaria_SelectedValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmb_CajaBancaria.SelectedValueChanged
        ...
        If cmb_CajaBancaria.Items.Count > 0 Then
            If cmb_CajaBancaria.SelectedValue = 0 Then
                cmb_Grupo.ActualizaValorParametro("@Id_CajaBancaria", -1)
                cmb_Cuenta.ActualizaValorParametro("@Id_CajaBancaria", -1)
            Else
                cmb_Grupo.ActualizaValorParametro("@Id_CajaBancaria", cmb_CajaBancaria.SelectedValue)
                cmb_Cuenta.ActualizaValorParametro("@Id_CajaBancaria", cmb_CajaBancaria.SelectedValue)
            End If
            cmb_Grupo.Actualizar()
            cmb_Cuenta.Actualizar()
        End If
    ...
    Private Sub cmb_Moneda_SelectedValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmb_Moneda.SelectedValueChanged
        ...
        If cmb_Moneda.Items.Count > 0 Then
            If cmb_Moneda.SelectedValue = 0 Then
                cmb_Cuenta.ActualizaValorParametro("@Id_Moneda", -1)
            Else
                cmb_Cuenta.ActualizaValorParametro("@Id_Moneda", cmb_Moneda.SelectedValue)
            End If
            cmb_Cuenta.Actualizar()
        End If
    End Sub
    ...
    Private Sub dtp_Desde_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dtp_Desde.ValueChanged
        If cmb_Desde.Items.Count > 0 Then
    ...
    Private Sub dtp_Hasta_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dtp_Hasta.ValueChanged
        If cmb_Hasta.Items.Count > 0 Then
    ...
    Private Function Validar() As Boolean
        ...
        If chk_Corte.Enabled AndAlso (tbx_Corte.Text = 0 OrElse tbx_Corte.Text = "") AndAlso Not chk_Corte.Checked Then
