...
Public Class frm_Login
    ...
    Private Sub frm_Login_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If (Application.ApplicationDeployment.IsNetworkDeployed) Then
            ...
            lbl_Modulo.Text = "Módulo Pre-Facturación v" & String.Format("{0}", myVersion)
            ModuloVersion = String.Format("{0}", myVersion)
        Else
            lbl_Modulo.Text = "Módulo Pre-Facturación"
    ...
    Sub Validar()
        ...
        If Not FuncionesGlobales.fn_Valida_Cadena(tbx_Numero.Text.Trim, FuncionesGlobales.Validar_Cadena.Numeros_Enteros) Then
            MsgBox("'" & tbx_Numero.Text.Trim & "', No es un ID de Empelado válido.", MsgBoxStyle.Critical, frm_MENU.Text)
            Exit Sub
        End If
        If Contra = "" Then
        ...
        If ServDatos <> "" And BaseDatos <> "" And UsuarioDatos <> "" And ContraDatos <> "" Then
            Cnx_Datos = "Data Source=" & ServDatos & ";Initial Catalog=" & BaseDatos & ";User Id=" & UsuarioDatos & ";Password=" & ContraDatos & ";Connection Timeout=30;"
        Else
            MsgBox("No se pudo obtener la información suficiente para establecer la conexión... Consulte al Administrador del Sistema.", MsgBoxStyle.Critical, frm_MENU.Text)
            Windows.Forms.Application.Exit()
            Exit Sub
        ...
        Else
            ...
            'INSERTAR EN USR_REGISTRO_LOGIN
            LoginId = 0
            ...
            Else
                ...
                Else '(Tipos: 2, 4 y 5)
                    ...
                    Call ControlesPermisos()
                End If
                'que seleccione la Empresa y Sucursal
                If UsuarioTipo = 3 Or UsuarioTipo = 4 Or UsuarioTipo = 5 Then
                    'Cuando es un Usuario a Nivel de Empresa o Global debe seleccionar
                    'La Sucursal en la que trabajará
                    BanderA = False
