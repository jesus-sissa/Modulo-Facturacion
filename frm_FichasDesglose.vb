...
Public Class frm_FichasDesglose
    ...
    Private Sub frm_DesgloseModal_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Cn_Facturacion.fn_DesgloseModal_LlenarEfectivoFicha(lsv_Efectivo, Id_Ficha) Then
        ...
        If Not Cn_Facturacion.fn_DesgloseModal_LlenarChequesFicha(lsv_Cheques, Id_Ficha) Then
        ...
        If Not Cn_Facturacion.fn_DesgloseModal_LlenarOtrosFicha(lsv_Otros, Id_Ficha) Then
        ...
        If Not Cn_Facturacion.fn_ParcialesModal_LlenarLista(lsv_Parciales, Id_Ficha) Then
